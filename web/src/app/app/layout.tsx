  ...
  return (
    <div className="h-screen overflow-hidden bg-[color:var(--bg)] text-[color:var(--text)]">
      <div className="mx-auto flex h-full w-full max-w-6xl gap-4 px-4 py-6">
        <aside className="hidden h-full w-60 shrink-0 overflow-hidden md:block">
          <div className="flex h-full flex-col overflow-hidden rounded-[var(--radius)] border border-[color:var(--border)] bg-[color:var(--card)] p-4 shadow-[var(--shadow)]">
